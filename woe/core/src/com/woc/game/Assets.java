...
public class Assets {
	...
	public static TextureRegion bulb;
	public static TextureRegion blurball;
	public static TextureRegion donatom;
	public static TextureRegion powerstation;
	...
	public static void load() {
		...
		bulb = atlas.findRegion("bulb");
		blurball = atlas.findRegion("blurball");
		donatom = atlas.findRegion("don-atom");
		powerstation = atlas.findRegion("powerstation");
		beam = atlas.findRegion("beam");
